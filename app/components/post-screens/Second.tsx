...
const Second = () => {
  return (
    <div>
      ...
      <OptionsButton title='Garbage' desc='Items meant in the landfills' SVG={Garbage} />
      <div className='mt-4'>
        <OptionsButton title='Recycling' desc='Items that can be reused for other purposes' SVG={Recycle} />
      </div>
      <div className='mt-4'>
        <OptionsButton title='Compost' desc='Items that are meant to go back into the soil (food)' SVG={Food} />
      </div>
    </div>
  );
}
