...
const Page: React.FC = () => {
    ...
    return (
        <div className="flex h-screen">
            <div className='border-r border-gray-300 p-4 w-4/12 h-full'>
                <h1 className='text-3xl font-medium mb-8'>Bin Editor</h1>
                <div className="overflow-y-auto hide-scrollbar max-h-[90%]">
                    <div className='flex flex-col items-center space-y-4'>
                        <div 
                            className='flex flex-col text-sm border-2 rounded-lg shadow-xl py-3.5 px-4 cursor-pointer w-5/6 hover:scale-95 duration-300'
                        ...
                        <div 
                            className='text-sm border-2 rounded-lg shadow-xl py-3.5 px-4 cursor-pointer w-5/6 hover:scale-95 duration-300'
            ...
            <div className="flex-1 p-4 items-center justify-center flex">
                {renderContent()}
            </div>
        </div>
    );
